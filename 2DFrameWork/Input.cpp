...
{
    //Screen To World
    mouseWPos.x = mouseSPos.x - app.GetHalfWidth() + CAM->position.x;
    //mouseWPos.y = app.GetHeight() - mouseSPos.y - app.GetHalfHeight();
    mouseWPos.y = app.GetHalfHeight() - mouseSPos.y + CAM->position.y;
